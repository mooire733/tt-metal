...
[`minimax_h3_wormhole/README.md`](minimax_h3_wormhole/README.md) (baseline, block breakdown and the per-op
optimization docs in that directory) and [`MiniMaxH3_wormhole_hang.md`](MiniMaxH3_wormhole_hang.md). The
Wormhole AGMM fused-vs-unfused blocking study
