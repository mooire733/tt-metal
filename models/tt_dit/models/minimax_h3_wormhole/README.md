...
MM/RS gate (the accidental Wormhole fused MM/RS path, root-caused in `../MiniMaxH3_wormhole_hang.md` and
closed in `eab3dfbd599`) and the 5 blocked points now all pass.
