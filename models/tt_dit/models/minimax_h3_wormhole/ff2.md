...
`M=13664` keying itself was the fix for the rows-per-device mismatch (`../MiniMaxH3_rows_per_device_mismatch.md`).
...
path was the mid-denoise hang, `../MiniMaxH3_wormhole_hang.md`).
