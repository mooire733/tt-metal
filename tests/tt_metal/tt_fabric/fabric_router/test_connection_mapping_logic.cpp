...
TEST_F(RouterConnectionMappingTest, AsymmetricConnections_MeshToZ_vs_ZToMesh) {
    ...
    auto mesh_mapping = RouterConnectionMapping::for_mesh_router(Topology::Mesh, RoutingDirection::N, true);
...
TEST_F(RouterConnectionMappingTest, AsymmetricConnections_VCAssignments) {
    ...
    auto mesh_mapping = RouterConnectionMapping::for_mesh_router(Topology::Mesh, RoutingDirection::E, true);
...
TEST_F(RouterConnectionMappingTest, ConnectionTypeFiltering_LocalOnly) {
    ...
    EXPECT_EQ(
        z_to_mesh_count,
        static_cast<int>(builder_config::num_mesh_directions_2d));  // Z_TO_MESH for all mesh directions
...
TEST_F(RouterConnectionMappingTest, MultiVC_MeshRouter_VC0_and_VC1) {
    ...
    auto mesh_mapping = RouterConnectionMapping::for_mesh_router(Topology::Mesh, RoutingDirection::W, true);
...
TEST_F(RouterConnectionMappingTest, DirectionBased_ZRouter_ChannelToDirection) {
    ...
    std::vector<std::pair<uint32_t, RoutingDirection>> expected = {
        {0, RoutingDirection::N}, {1, RoutingDirection::E}, {2, RoutingDirection::S}, {3, RoutingDirection::W}};
...
TEST_F(RouterConnectionMappingTest, DirectionBased_MeshRouter_MeshToZ) {
    ...
    auto mesh_mapping = RouterConnectionMapping::for_mesh_router(Topology::Mesh, RoutingDirection::S, true);
...
TEST_F(RouterConnectionMappingTest, Regression_MeshToMesh_StillWorks) {
    ...
    auto mesh_n = RouterConnectionMapping::for_mesh_router(Topology::Mesh, RoutingDirection::N, false);

    auto mesh_s = RouterConnectionMapping::for_mesh_router(Topology::Mesh, RoutingDirection::S, false);
...
TEST_F(RouterConnectionMappingTest, Regression_1D_Topology_StillWorks) {
    ...
    auto mesh_1d = RouterConnectionMapping::for_mesh_router(Topology::Linear, RoutingDirection::E, false);
