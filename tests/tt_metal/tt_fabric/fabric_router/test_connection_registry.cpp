...
TEST_F(ConnectionRegistryTest, GetConnectionsFromSource_NoMatches) {
    ...
    auto results = registry_->get_connections_from_source(FabricNodeId(MeshId{0}, 99), RoutingDirection::E);
...
TEST_F(ConnectionRegistryTest, Phase2_MeshRouter_2D_WithZ_MultipleTargets) {
    ...
    auto mapping = RouterConnectionMapping::for_mesh_router(Topology::Mesh, RoutingDirection::N,
                                                            true);  // Has Z router
...
TEST_F(ConnectionRegistryTest, Phase2_EdgeDevice_2MeshRouters_MappingDriven) {
    ...
    std::vector<RoutingDirection> mesh_directions = {RoutingDirection::N, RoutingDirection::E};
    ...
    std::set<RoutingDirection> existing_routers = {RoutingDirection::N, RoutingDirection::E};
