...
TEST_F(ZRouterDeviceDetectionTest, MeshRouter_NoZ_AllDirections) {
    ...
    for (auto direction : directions) {
        auto mapping = RouterConnectionMapping::for_mesh_router(Topology::Mesh, direction, false);
...
TEST_F(ZRouterDeviceDetectionTest, MeshRouter_NoZ_1D_NoExtraChannel) {
    ...
    auto mapping = RouterConnectionMapping::for_mesh_router(Topology::Linear, RoutingDirection::E, false);
...
TEST_F(ZRouterDeviceDetectionTest, MeshRouter_WithZ_HasMeshToZConnection) {
    ...
    auto mapping = RouterConnectionMapping::for_mesh_router(Topology::Mesh, RoutingDirection::E, true);
...
TEST_F(ZRouterDeviceDetectionTest, MeshRouter_WithZ_AllDirections) {
    ...
    for (auto direction : directions) {
        auto mapping = RouterConnectionMapping::for_mesh_router(Topology::Mesh, direction, true);
...
TEST_F(ZRouterDeviceDetectionTest, MeshRouter_WithZ_1D_HasZConnection) {
    ...
    auto mapping = RouterConnectionMapping::for_mesh_router(Topology::Linear, RoutingDirection::E, true);
...
TEST_F(ZRouterDeviceDetectionTest, Comparison_MeshWithZ_vs_MeshWithoutZ) {
    auto mapping_no_z = RouterConnectionMapping::for_mesh_router(Topology::Mesh, RoutingDirection::E, false);
    auto mapping_with_z = RouterConnectionMapping::for_mesh_router(Topology::Mesh, RoutingDirection::E, true);
    ...
    uint32_t intra_mesh_no_z = std::count_if(targets_no_z.begin(), targets_no_z.end(), [](const ConnectionTarget& t) {
        return t.type == ConnectionType::INTRA_MESH;
    });
    uint32_t intra_mesh_with_z =
        std::count_if(targets_with_z.begin(), targets_with_z.end(), [](const ConnectionTarget& t) {
            return t.type == ConnectionType::INTRA_MESH;
        });
    ...
    auto mesh_to_z_it = std::find_if(targets_with_z.begin(), targets_with_z.end(), [](const ConnectionTarget& t) {
...
TEST_F(ZRouterDeviceDetectionTest, Comparison_2D_vs_1D_WithZ) {
    auto mapping_2d = RouterConnectionMapping::for_mesh_router(Topology::Mesh, RoutingDirection::E, true);
    auto mapping_1d = RouterConnectionMapping::for_mesh_router(Topology::Linear, RoutingDirection::E, true);
