...
# ---------------------------------------------------------------------------------------------
# Inlined Python oracle of the fused geometry (design D3/D8/D9). Kept self-contained on purpose:
...
# ---------------------------------------------------------------------------------------------
# The cost model and the feasibility predicate mirror the oracle (N7/N12)
# ---------------------------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------------------------
# N4 / N12: the factory's own core map, on every grid
# ---------------------------------------------------------------------------------------------
...
def test_chosen_layout_shares_no_links(grid, bh):
    """N13: the layout the cost model picks (at the production chunk count) keeps each head's hand-off
