...
#include "ckernel_sfpu_tt_poly_tti_replay.h"
namespace sfpi {
...
#error "square-affine target differs from its selected source"
    ...
    defined(TT_WH_CORE_SAME_ROW_GRAD_FINALIZE) || defined(TT_WH_EXPONENT_ALU_LOG2_TERMINALS) ||                        \
    defined(TT_WH_FACTORED_CORE_MIRROR_FOLD) || defined(TT_WH_NORMALIZED_LOG1P_TERMINALS) ||                           \
    defined(TT_WH_RAW_NAN_UNION) || defined(TT_WH_SYMMETRIC_EXP_POOL)
...
#include "ckernel_sfpu_tt_poly_domain_symmetric_constant.inc"
#include "ckernel_sfpu_tt_poly_domain_finalize.inc"
#include "ckernel_sfpu_tt_poly_encoded_domain_finalize.inc"
#include "ckernel_sfpu_tt_poly_asymptotic_exp.inc"
#include "ckernel_sfpu_tt_poly_asymptotic_factor.inc"
#include "ckernel_sfpu_tt_poly_polynomial_dual_tile.inc"
