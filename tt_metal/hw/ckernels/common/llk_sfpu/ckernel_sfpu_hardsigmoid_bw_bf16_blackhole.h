...
#error "selected factor target differs from its compiled schedule"
    ...
    defined(TT_SPECIAL_COMPARE_MAGNITUDE_POS_ZERO) || defined(TT_SPECIAL_COMPARE_POS_ZERO) ||                          \
    ...
    defined(TT_TARGET_BH_BF16_RAW_SIGNED_NONFINITE_SPLIT) || defined(TT_TARGET_BH_FP32_RAW_NEG_ZERO_DISCRIMINATOR) ||  \
    defined(TT_WH_CORE_SAME_ROW_GRAD_FINALIZE) || defined(TT_WH_DST_CERTIFIED_MIRROR) ||                               \
    defined(TT_WH_DST_COEFF_ROW_UNROLL) || defined(TT_WH_EXPONENT_ALU_LOG2_TERMINALS) ||                               \
    defined(TT_WH_FACTORED_CORE_MIRROR_FOLD) || defined(TT_WH_NORMALIZED_LOG1P_TERMINALS) ||                           \
    defined(TT_WH_RAW_NAN_UNION)
...
#pragma push_macro("TT_INLINE_PROGRAM_GRADIENT_SCALE")
#undef TT_INLINE_PROGRAM_GRADIENT_SCALE
...
namespace ttpoly_generated::HardsigmoidBwBf16Config_detail {
...
constexpr std::array<float, LUT_SIZE_BF16> LUT_DATA_BF16 = {
    {-1.0000000000000000e+01f,
     -2.9999997615999998e+00f,
     3.0000000000000000e+00f,
     1.0000000000000000e+01f,
     0.0000000000000000e+00f,
     0.0000000000000000e+00f,
     1.6666667163372040e-01f,
     0.0000000000000000e+00f,
     0.0000000000000000e+00f,
     0.0000000000000000e+00f}};
...
constexpr float TT_TARGET_BH_BF16_RAW_NEG_NAN_CONSTANT = 1.6666667163372040e-01f;
#define TT_TARGET_BH_BF16_RAW_POS_NAN_DISCRIMINATOR
#define TT_TARGET_BH_BF16_RAW_POS_NAN_RESULT 6
constexpr float TT_TARGET_BH_BF16_RAW_POS_NAN_CONSTANT = 1.6666667163372040e-01f;
...
// Selected zero-mask identity: 037db1da46ee00335cc173d35764d1760a5c2ef5fbc14145cb246d9838c0ed2a
#define TT_INLINE_PROGRAM_GRAD_ZERO_MASK_SELECT 1
#define TT_INLINE_PROGRAM_GRADIENT_SCALE 1.6666667163372040e-01f

#include "ckernel_sfpu_tt_poly_domain_prepare.inc"
#include "ckernel_sfpu_tt_poly_domain_action_coordinate.inc"
#include "ckernel_sfpu_tt_poly_raw_class_policy.inc"
#include "ckernel_sfpu_tt_poly_target_special_policy.inc"
#include "ckernel_sfpu_tt_poly_domain_finalize.inc"
#include "ckernel_sfpu_tt_poly_encoded_domain_finalize.inc"
namespace dstcoeff {
struct Layout {
...
#include "ckernel_sfpu_tt_poly_polynomial_dst_tile.inc"
inline void tile() { piecewise_generic_lut_dst_coeff<POLY_DEGREE, NUM_SEGMENTS, LUT_SIZE>(LUT_DATA); }
#include "ckernel_sfpu_tt_poly_gradient_finalize.inc"

}  // namespace ttpoly_generated::HardsigmoidBwBf16Config_detail
namespace ttpoly_generated {
struct HardsigmoidBwBf16Config {
    static inline void tile() { HardsigmoidBwBf16Config_detail::tile(); }
    struct Gradient {
        static inline void tile() { HardsigmoidBwBf16Config_detail::fuse_grad_mul(); }
    };
};
}  // namespace ttpoly_generated
...
#pragma pop_macro("TT_INLINE_PROGRAM_GRADIENT_SCALE")
...
#include "ckernel_sfpu_tt_poly_config_tile.h"
