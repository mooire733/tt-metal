...
#error "selected factor target differs from its compiled schedule"
    ...
    defined(TT_SPECIAL_COMPARE_MAGNITUDE_POS_ZERO) || defined(TT_SPECIAL_COMPARE_POS_INF) ||                           \
    ...
    defined(TT_WH_RAW_NAN_UNION) || defined(TT_WH_REDUCED_POLY_UNROLL32) ||                                            \
    defined(TT_WH_SIGNED_ABS_COEFFICIENT_STORE) || defined(TT_WH_SIGNED_ABS_UNROLL32) ||                               \
    defined(TT_WH_SYMMETRIC_EXP_POOL)
...
// Selected zone ownership: 57c6410c6b80c21987dc18812cc383e6a54512646f9465908d11d4769712d217

#include "ckernel_sfpu_tt_poly_selected_core_total.inc"
...
#include "ckernel_sfpu_tt_poly_zone_gradient_finalize.inc"
...
using namespace sfpi;
#include "ckernel_sfpu_tt_poly_gradient_finalization_owner.inc"
inline void init() {
#if defined(ARCH_WORMHOLE) && defined(TRISC_MATH)
    ckernel::llk_math_sfpu_init_once();
#endif
#include "ckernel_sfpu_tt_poly_selected_reciprocal_init.inc"
#include "ckernel_sfpu_tt_poly_selected_exp_pool_init.inc"
}
}  // namespace ttpoly_generated::HardswishBwBf16Config_execution
