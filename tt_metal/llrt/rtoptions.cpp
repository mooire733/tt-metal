...
enum class EnvVarID {
    ...
    TT_METAL_DISABLE_FDS,               // Quasar: force worker go and completion signalling onto the NOC path
...
void RunTimeOptions::HandleEnvVar(EnvVarID id, const char* value) {
    switch (id) {
        ...
        // Quasar: use NOC for worker go and worker completion signalling instead of FDS.
        // Default: false (use FDS for signalling)
