...
#define TT_APOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst)  TT_INSN(TT_OP_APOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst))
#define TTI_APOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst) TTI_INSN(TT_OP_APOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst))
...
#define TT_APOOL3S2_VALID(clear_dvalid, pool_addr_mode, index_en, dst) \
    (ckernel::is_valid(clear_dvalid, 2) && ckernel::is_valid(pool_addr_mode, 7) && ckernel::is_valid(index_en, 1) && ckernel::is_valid(dst, 14))
#define TT_APOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst)  TT_INSN(TT_OP_APOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst))
#define TTI_APOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst) TTI_INSN(TT_OP_APOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst))
...
#define TT_CFGSHIFTMASK(disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel, CfgReg) \
    TT_INSN(TT_OP_CFGSHIFTMASK(disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel, CfgReg))
#define TTI_CFGSHIFTMASK(disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel, CfgReg) \
    TTI_INSN(TT_OP_CFGSHIFTMASK(disable_mask_on_old_val, operation, mask_width, right_cshift_amt, scratch_sel, CfgReg))
...
#define TT_GAPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst) \
    TT_INSN(TT_OP_GAPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst))
#define TTI_GAPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst) \
    TTI_INSN(TT_OP_GAPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst))
...
#define TT_GMPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst) \
    TT_INSN(TT_OP_GMPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst))
#define TTI_GMPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst) \
    TTI_INSN(TT_OP_GMPOOL(clear_dvalid, instr_mod19, pool_addr_mode, max_pool_index_en, dst))
...
#define TT_MOP(mop_type, loop_count, zmask_lo16_or_loop_count)  TT_INSN(TT_OP_MOP(mop_type, loop_count, zmask_lo16_or_loop_count))
#define TTI_MOP(mop_type, loop_count, zmask_lo16_or_loop_count) TTI_INSN(TT_OP_MOP(mop_type, loop_count, zmask_lo16_or_loop_count))
...
#define TT_MOVB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst)  TT_INSN(TT_OP_MOVB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst))
#define TTI_MOVB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst) TTI_INSN(TT_OP_MOVB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst))
...
#define TT_MOVDBGB2D_VALID(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst)                                                                      \
    (ckernel::is_valid(dest_32b_lo, 1) && ckernel::is_valid(src, 6) && ckernel::is_valid(addr_mode, 3) && ckernel::is_valid(movb2d_instr_mod, 3) && \
     ckernel::is_valid(dst, 11))
#define TT_MOVDBGB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst)  TT_INSN(TT_OP_MOVDBGB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst))
#define TTI_MOVDBGB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst) TTI_INSN(TT_OP_MOVDBGB2D(dest_32b_lo, src, addr_mode, movb2d_instr_mod, dst))
...
#define TT_MPOOL3S1_VALID(clear_dvalid, pool_addr_mode, index_en, dst) \
    (ckernel::is_valid(clear_dvalid, 2) && ckernel::is_valid(pool_addr_mode, 7) && ckernel::is_valid(index_en, 1) && ckernel::is_valid(dst, 14))
#define TT_MPOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst)  TT_INSN(TT_OP_MPOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst))
#define TTI_MPOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst) TTI_INSN(TT_OP_MPOOL3S1(clear_dvalid, pool_addr_mode, index_en, dst))
...
#define TT_MPOOL3S2_VALID(clear_dvalid, pool_addr_mode, index_en, dst) \
    (ckernel::is_valid(clear_dvalid, 2) && ckernel::is_valid(pool_addr_mode, 7) && ckernel::is_valid(index_en, 1) && ckernel::is_valid(dst, 14))
#define TT_MPOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst)  TT_INSN(TT_OP_MPOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst))
#define TTI_MPOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst) TTI_INSN(TT_OP_MPOOL3S2(clear_dvalid, pool_addr_mode, index_en, dst))
...
#define TT_PACR_SETREG(Push, ModeSel, Unused, DisableStall, AddrSel, StreamId, Flush, Last) \
    TT_INSN(TT_OP_PACR_SETREG(Push, ModeSel, Unused, DisableStall, AddrSel, StreamId, Flush, Last))
#define TTI_PACR_SETREG(Push, ModeSel, Unused, DisableStall, AddrSel, StreamId, Flush, Last) \
    TTI_INSN(TT_OP_PACR_SETREG(Push, ModeSel, Unused, DisableStall, AddrSel, StreamId, Flush, Last))
...
#define TT_SFPARECIP_VALID(imm12_math, lreg_c, lreg_dest, instr_mod1) \
    (ckernel::is_valid(imm12_math, 12) && ckernel::is_valid(lreg_c, 4) && ckernel::is_valid(lreg_dest, 4) && ckernel::is_valid(instr_mod1, 4))
#define TT_SFPARECIP(imm12_math, lreg_c, lreg_dest, instr_mod1)  TT_INSN(TT_OP_SFPARECIP(imm12_math, lreg_c, lreg_dest, instr_mod1))
#define TTI_SFPARECIP(imm12_math, lreg_c, lreg_dest, instr_mod1) TTI_INSN(TT_OP_SFPARECIP(imm12_math, lreg_c, lreg_dest, instr_mod1))
...
#define TT_SFPMUL24(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) \
    TT_INSN(TT_OP_SFPMUL24(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1))
#define TTI_SFPMUL24(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1) \
    TTI_INSN(TT_OP_SFPMUL24(lreg_src_a, lreg_src_b, lreg_src_c, lreg_dest, instr_mod1))
...
#define TT_STREAMWAIT(stall_res, target_value, target_sel, wait_stream_sel)  TT_INSN(TT_OP_STREAMWAIT(stall_res, target_value, target_sel, wait_stream_sel))
#define TTI_STREAMWAIT(stall_res, target_value, target_sel, wait_stream_sel) TTI_INSN(TT_OP_STREAMWAIT(stall_res, target_value, target_sel, wait_stream_sel))
...
#define TT_STREAMWRCFG(stream_id_sel, StreamRegAddr, CfgReg)  TT_INSN(TT_OP_STREAMWRCFG(stream_id_sel, StreamRegAddr, CfgReg))
#define TTI_STREAMWRCFG(stream_id_sel, StreamRegAddr, CfgReg) TTI_INSN(TT_OP_STREAMWRCFG(stream_id_sel, StreamRegAddr, CfgReg))
