...
// Design D8 (v0.3): the per-head row-local cost model, calibrated on QB2 (design doc §5):
...
// knobs are unset; test_chunk_gdn_fused_geometry.py checks it against a Python oracle on several grids.
